...
class Fundamental(Base):
    ...
    equity: Mapped[Decimal | None] = mapped_column(Numeric(24, 2), nullable=True)
    operating_cashflow: Mapped[Decimal | None] = mapped_column(Numeric(24, 2), nullable=True)
    eps: Mapped[Decimal | None] = mapped_column(Numeric(12, 4), nullable=True)
    report_period: Mapped[str | None] = mapped_column(String(10), nullable=True)
