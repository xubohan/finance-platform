"""Double exponential moving-average crossover strategy."""
...
class DEMACrossStrategy(BaseStrategy):
    """Buy when fast DEMA crosses above slow DEMA, sell on reverse cross."""
    ...
    def generate_signal(self, df: pd.DataFrame) -> int:
        ...
        fast_line = self._dema(close, self.fast)
        slow_line = self._dema(close, self.slow)
