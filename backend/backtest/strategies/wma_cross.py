...
class WMACrossStrategy(BaseStrategy):
    """Buy when fast weighted MA crosses above slow weighted MA, sell on reverse cross."""
    ...
    def generate_signal(self, df: pd.DataFrame) -> int:
        ...
        fast_line = self._weighted_ma(close, self.fast)
        slow_line = self._weighted_ma(close, self.slow)
