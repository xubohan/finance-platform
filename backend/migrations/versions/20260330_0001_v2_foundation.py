...
UPGRADE_STATEMENTS = (
    ...
    "CREATE INDEX IF NOT EXISTS idx_ohlcv_symbol_time ON ohlcv_daily(symbol, asset_type, time DESC)",
    """
...
DOWNGRADE_STATEMENTS = (
    "DROP TABLE IF EXISTS backtest_cache",
    "DROP TABLE IF EXISTS market_snapshot_daily",
    "DROP TABLE IF EXISTS llm_analysis_cache",
    "DROP TABLE IF EXISTS watchlist_items",
    "DROP TABLE IF EXISTS event_impact_records",
    "DROP TABLE IF EXISTS market_events",
    "DROP TABLE IF EXISTS news_items",
    "DROP TABLE IF EXISTS cn_big_order_flow",
    "DROP TABLE IF EXISTS cn_dragon_tiger",
    "DROP TABLE IF EXISTS cn_northbound_flow",
    "DROP TABLE IF EXISTS cn_margin_trading",
